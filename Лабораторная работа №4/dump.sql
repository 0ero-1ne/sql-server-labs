...
insert into
	AUDITORIUM (AUDITORIUM, AUDITORIUM_NAME, AUDITORIUM_TYPE, AUDITORIUM_CAPACITY)   
...
(
	id int PRIMARY KEY NOT NULL,
	title nvarchar(100),
	book_id int constraint LIB_BOOK_FK foreign key references BOOKS(id)
);

INSERT INTO LIB VALUES (1, 'Library 1', 1),
					   (2, 'Library 2', 1),
					   (3, 'Library 3', 2),
					   (4, 'Library 4', 2),
					   (5, 'Library 5', NULL);